function Fmat_8point = task5_eight_point(image1, image2)

%test eight point algorithm

%im = imread('arctriomphe1.jpg');
%im2 = imread('arctriomphe2.jpg');
...
L = ([x2' ; y2'; ones(size(x2'))]' * Fmat_8point)' ;
[nr,nc,nb] = size(im);
...
for j=1:3
    for i=1:3
        fprintf('%10g ',10000*Fmat_8point(j,i));
    end
    fprintf('\n');
end
